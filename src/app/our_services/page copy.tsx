...
export default function OurServices() {
  ...
  // }, []); 
    ...
    let ctx = gsap.context((self) => {
      ...
      // Seting up style
      gsap.set(mainContainer.current,{height:'1500vh'});
      ...
      mainTimeLine.fromTo('.content',{borderRadius:'15px'},{borderRadius:'15px',duration:10},190)//h5
    ...
    <main className={"w-full relative opacity-0"} ref={mainContainer}>
      ...
      <div className='min-w-screen'>
        ...
        <div className='min-w-screen min-h-screen fixed lastBox titles_to_appear top-0 pt-8' ref={firstBox}>
          <h1 className='absolute'><span className='block firstBigTitle'>Steel</span><span className='block firstBigTitle'>Framing</span></h1>
