  ...
  return (
    <div className="p-6 bg-white">
      ...
      <div className="flex items-center justify-center w-full">
        <div className="relative w-full px-5 h-fit">
          <div className="relative w-full h-full">
            <div className="absolute z-0 w-full h-full bg-red skew-x-12"></div>
            <div className="relative z-10 w-full h-full py-10 px-20">
