  ...
  return (
    <div className={"h-screen w-screen flex items-center "+style.endSectionMain}>
      <div className={"block w-screen "+style.endSections }>
        <div className={"grid grid-cols-5 "+style.points_container}>
          <div className="col-span-1 h-full">
            <div className="main_points h-full w-full flex flex-col justify-center items-center">
              ...
              <h1 className='text-white font-bold mt-5'>MAS RAPIDO</h1>
            </div>
          </div>
          <div className="col-span-1 h-full">
            <div className="main_points h-full w-full flex flex-col justify-center items-center">
              ...
              <h1 className='text-white font-bold mt-5'>EFICIENCIA ENERGETICA</h1>
            </div>
          </div>
          <div className="col-span-1 h-full">
            <div className="main_points h-full w-full flex flex-col justify-center items-center">
              ...
              <h1 className='text-white font-bold mt-5'>DURABILIDAD</h1>
            </div>
          </div>
          <div className="col-span-1 h-full">
            <div className="main_points h-full w-full flex flex-col justify-center items-center">
              <svg style={{width:"100px",height:"100px"}} viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"><defs></defs><polyline className={style.cls_1} points="20 8.5 20 22.5 4 22.5 4 8.5"/><polyline className={style.cls_1} points="23 10.5 12 1.5 1 10.5"/><polygon className={style.cls_1} points="15 12.5 12 12.5 12 9.5 9 13.5 12 13.5 12 16.5 15 12.5"/></svg>
              <h1 className='text-white font-bold mt-5'>FLEXIBILIDAD</h1>
            </div>
          </div>
          <div className="col-span-1 h-full">
            <div className="main_points h-full w-full flex flex-col justify-center items-center">
              ...
              <h1 className='text-white font-bold mt-5'>MAS LIVIANO</h1>
            </div>
          </div>
          <div className="col-span-5 h-full">
            <div className="main_points h-full w-full flex flex-col justify-start items-center">
              <p className='text-white text-center mt-5 text-xl  w-3/5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque eum fugit ex officiis fuga consectetur, autem, iure dolor molestias tempora harum repellat perferendis quia repellendus facere quisquam doloribus qui hic.</p>  
            </div>
          </div>
          <div className="col-span-5 h-full">
            <div className="main_points h-full w-full flex flex-col justify-start items-center">
