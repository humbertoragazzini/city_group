...
const EndSections = () => {
  ...
  useLayoutEffect(() => {
    ...
    let ctx = gsap.context((self) => {
      ...
      const mainTL = gsap.timeline({scrollTrigger: {trigger: main.current,pinSpacing:false,pinSpacer:'none',start: "top center",end: "center center",scrub: 1,markers: true},duration:10})
