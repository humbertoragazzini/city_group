      ...
      <div className={'min-h-screen relative bg-slate-900 overflow-hidden '+styles.main} ref={mainContainer}>
        ...
        <div className='content_box w-100 lg:w-4/5 xxl:w-1/2 mx-auto p-9 relative'>
          ...
          <div className="grid grid-cols-10">
            {/* TEXT */}
            <div className={"col-start-1 col-end-11 lg:col-start-1 lg:col-end-6 pt-20 pb-20  lg:pt-20 lg:pb-20 h-screen item_text text-xl "+styles.item}>
            ...
            {/* TEXT */}
            <div className={"col-start-1 col-end-11 lg:col-start-5 lg:col-end-10 pt-20 pb-20  lg:pt-20 lg:pb-20 h-screen item_text text-xl  "+styles.item}>
              <h2 className="text-white text-2xl font-bold mb-4">
                Nuestros Pilares
              </h2>
              <p className="text-white">
            ...
            {/* TEXT */}
            <div className={"col-start-1 col-end-11 lg:col-start-1 lg:col-end-6  pt-20 pb-20 h-screen flex justify-center items-center flex-col item_text text-xl last_item "}>
