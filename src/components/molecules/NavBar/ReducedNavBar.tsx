...
export default function ReducedNavBar({
  ...
  return (
    <>
      <nav
        className={
          "absolute overflow-hidden h-[60px] flex flex-row items-center justify-start transition-all duration-1000 bg-[rgba(17,31,42,0.7)] backdrop-blur-lg w-[120px] left-[-60px] rounded-r-full ml-0 top-4 justify-between hover:left-0 " +
          (transforBar ? "" : "md:opacity-0 md:pointer-events-none")
        }
      >
        {/* Primalports home page link */}
        <NavBarLBTN
          className={
            "relative !w-[60px] !h-[60px] flex  justify-center items-center bg-[rgba(17,31,42,1)] rounded-r-full z-10"
          }
        ...
        <NavBarLBTN
          className={
            "!absolute top-0 left-[35px] !w-[110px] !h-[60px] flex justify-center items-center hover:bg-[rgba(0,0,0,0.8)] rounded-r-full z-0"
          }
          transforBar={transforBar}
          href={""}
