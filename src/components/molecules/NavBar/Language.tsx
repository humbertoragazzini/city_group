...
export default function Language() {
  ...
  return (
    ...
    >
      ...
      {state.language == "EN" && (
        <span className="ml-2 text-base">Language</span>
      )}
      {state.language == "ES" && <span className="ml-2 text-base">Idioma</span>}
      {state.language == "CH" && <span className="ml-2 text-base">语言</span>}
      {state.language == "IT" && <span className="ml-2 text-base">Lingua</span>}
    </button>
  );
}
