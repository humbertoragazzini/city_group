        ...
        {() => {
          return (
            <>
              ...
              >
                <div className="relative flex flex-col items-center justify-center h-full overflow-hidden text-white col-span-1 xl:col-span-2">
                  <MainHeader></MainHeader>
                  <div className="absolute md:hidden -right-8 translate-x-1/2 h-full lg:w-[calc(100%-200px)] xl:w-[calc(100%-750px)] aspect-square">
                    <LogoBG
                      className={
